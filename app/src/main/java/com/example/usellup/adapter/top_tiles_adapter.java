...
public class top_tiles_adapter extends RecyclerView.Adapter<com.example.usellup.adapter.top_tiles_adapter.MyViewHolder> {
    ...
    public top_tiles_adapter(List<main_cat_model> list, Context con, boolean isNewTask) {
        this.list = list;
    ...
    @Override
    public top_tiles_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_top_tiles, parent, false);
        return new top_tiles_adapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final top_tiles_adapter.MyViewHolder holder, final int position) {
...
holder.cat_type.setText("@ _user"+user);
